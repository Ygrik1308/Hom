...
static StatusTypeDef I2C_MasterRequestRead(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Timeout, uint32_t Tickstart);
...
static StatusTypeDef I2C_WaitOnSTOPFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart);
...
//{
//  hi2c1->Instance = I2C1;  								    ////  I2C1  - PB6,PB7
//  hi2c1->Init.ClockSpeed = 100000; 		 				    ////  I2C_ClockSpeed (Hz)
//  hi2c1->Init.DutyCycle = I2C_DUTYCYCLE_2;  				    ////  I2C_ DutyCycle 2 and 16/9
//  hi2c1->Init.OwnAddress1 = 0;								////  primary slave address  // основной ведомый адрес
//  hi2c1->Init.AddressingMode = I2C_ADDRESSINGMODE_7BIT;
//  hi2c1->Init.DualAddressMode = I2C_DUALADDRESS_DISABLE;
//  hi2c1->Init.OwnAddress2 = 0;
//  hi2c1->Init.GeneralCallMode = I2C_GENERALCALL_DISABLE;
//  hi2c1->Init.NoStretchMode = I2C_NOSTRETCH_DISABLE;
//  if (HAL_I2C_Init(hi2c1) != HAL_OK)  {Alarm(GPIOA);}
//}
